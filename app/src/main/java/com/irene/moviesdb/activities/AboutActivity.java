    ...
    private void loadActivity() {
        ...
        feedbackImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                feedbackIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{"irenedhawan1996@gmail.com"});
        ...
        sourceCodeOnGitHubCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                view.performHapticFeedback(HapticFeedbackConstants.VIRTUAL_KEY);
                String githubLink = "https://github.com/irene-dhawan/" + getResources().getString(R.string.app_name);
        ...
        openSourceLicensesFrameLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                view.performHapticFeedback(HapticFeedbackConstants.VIRTUAL_KEY);
                String attributionsLink = "https://github.com/irene-dhawan/" + getResources().getString(R.string.app_name) + "/blob/master/ATTRIBUTIONS.md";
