...
import com.irene.moviesdb.adapters.MovieCastsOfPersonAdapter;
...
import com.irene.moviesdb.network.movies.MovieCastOfPerson;
...
//        if (mTVCastsOfPersonsCall != null) mTVCastsOfPersonsCall.cancel();
    ...
    private void loadActivity() {
        ...
        mPersonDetailsCall = apiService.getPersonDetails(mPersonId, (Constants.APIKEY));
    ...
    private void setMovieCast(Integer personId) {
        ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
        mMovieCastsOfPersonsCall = apiService.getMovieCastsOfPerson(personId, (Constants.APIKEY));
