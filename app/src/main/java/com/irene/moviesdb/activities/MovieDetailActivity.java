...
import com.irene.moviesdb.adapters.MovieCastsAdapter;
import com.irene.moviesdb.adapters.VideoAdapter;
import com.irene.moviesdb.broadcastreceivers.ConnectivityBroadcastReceiver;
import com.irene.moviesdb.network.ApiClient;
import com.irene.moviesdb.network.ApiInterface;
import com.irene.moviesdb.network.movies.Genre;
import com.irene.moviesdb.network.movies.Movie;
import com.irene.moviesdb.network.movies.MovieBrief;
import com.irene.moviesdb.network.movies.MovieCastBrief;
...
import com.irene.moviesdb.network.videos.Video;
...
// irene : MovieDetailActivity and TVShowDetailActivity are mostly similar
...
//        mShareImageButton = (ImageButton) findViewById(R.id.image_button_share_movie_detail);
    ...
    protected void onDestroy() {
        ...
        // irene : you can make this lifecycle aware so the requests get canceled automatically on onDestroy()
    ...
    private void loadActivity() {
        ...
        mMovieDetailsCall = apiService.getMovieDetails(mMovieId, (Constants.APIKEY));
...
//        });
    ...
    private void setTrailers() {
        ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
        mMovieTrailersCall = apiService.getMovieVideos(mMovieId, (Constants.APIKEY));
    ...
    private void setCasts() {
        ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
        mMovieCreditsCall = apiService.getMovieCredits(mMovieId, (Constants.APIKEY));
    ...
    private void setSimilarMovies() {
        ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
        mSimilarMoviesCall = apiService.getSimilarMovies(mMovieId, (Constants.APIKEY), 1);
