...
import com.irene.moviesdb.activities.ViewAllMoviesActivity;
import com.irene.moviesdb.adapters.MovieBriefsLargeAdapter;
...
import com.irene.moviesdb.network.movies.GenresList;
...
import com.irene.moviesdb.utils.MovieGenres;
...
// irene : MoviesFragment and TVShowsFragment are mostly similar
public class MoviesFragment extends Fragment {
    ...
    private void loadFragment() {
        ...
        if (MovieGenres.isGenresListLoaded()) {
            ...
            mGenresListCall = apiService.getMovieGenresList((Constants.APIKEY));
    ...
    private void loadNowShowingMovies() {
        ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
        mProgressBar.setVisibility(View.VISIBLE);
        mNowShowingMoviesCall = apiService.getNowShowingMovies((Constants.APIKEY), 1, "US");
    ...
    private void loadPopularMovies() {
        ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
        mProgressBar.setVisibility(View.VISIBLE);
        mPopularMoviesCall = apiService.getPopularMovies((Constants.APIKEY), 1, "US");
    ...
    private void loadUpcomingMovies() {
        ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
        mProgressBar.setVisibility(View.VISIBLE);
        mUpcomingMoviesCall = apiService.getUpcomingMovies((Constants.APIKEY), 1, "US");
    ...
    private void loadTopRatedMovies() {
        ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
        mProgressBar.setVisibility(View.VISIBLE);
        mTopRatedMoviesCall = apiService.getTopRatedMovies((Constants.APIKEY), 1, "US");
